...
export class AppComponent {
  ...
  constructor(
    ...
    this.pages = [
      { title: 'کورپاڼه', component: "HomePage", icon: "book-outline", url: "home" },
      { title: 'کټګورۍ', component: "CategoryPage", icon: "reader-outline", url: "category" },
      { title: 'نښه شوې', component: "BookmarkPage", icon: "bookmarks-outline", url: "bookmark" },
      { title: 'زموږ په اړه', component: "AboutPage", icon: "flag-outline", url: "about" },
      { title: 'ژوندۍ بڼه', component: "AboutPage", icon: "flag-outline", url: "livetream" },
